          ...
          {editingName ? (
            <div className="flex flex-wrap items-end gap-3">
              <div>
                ...
                <input value={firstName} onChange={(e) => setFirstName(e.target.value)} className="input-field text-sm" />
              </div>
              <div>
                <label className="mb-1 block text-xs text-muted-foreground">Last Name</label>
                <input value={lastName} onChange={(e) => setLastName(e.target.value)} className="input-field text-sm" />
              </div>
              ...
              {show2faDisable ? (
                <div className="flex flex-wrap items-end gap-3 mt-4">
                  <div>
                    ...
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="input-field text-sm" />
                  </div>
                  <div>
                    <label className="mb-1 block text-xs text-muted-foreground">6-digit code</label>
                    <input value={totpCode} onChange={(e) => setTotpCode(e.target.value.replace(/\D/g, "").slice(0, 6))} maxLength={6} className="input-field w-24 text-sm" />
                  </div>
              ...
              {show2faSetup ? (
                ...
                <div className="flex flex-wrap items-end gap-3 mt-3">
                  <div>
                    ...
                    <input type="password" value={setupPwd} onChange={(e) => setSetupPwd(e.target.value)} className="input-field text-sm" />
                  </div>
